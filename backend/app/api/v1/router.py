...
api_router.include_router(elections.router, prefix="/elections", tags=["Elections"], dependencies=[Depends(get_current_user)])
api_router.include_router(offices.router, prefix="/offices", tags=["Offices"], dependencies=[Depends(get_current_user)])
api_router.include_router(municipalities.router, prefix="/municipalities", tags=["Municipalities"], dependencies=[Depends(get_current_user)])
...
api_router.include_router(list_templates.router, prefix="/list-templates", tags=["List Templates"], dependencies=[Depends(get_current_user)])
