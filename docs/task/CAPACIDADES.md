...
| CAP-04 | Reglas parametrizadas por cargo: edades, afiliación, paridad, alternancia y cantidad (RENAPER retirado por el usuario). | pp. 8, 11 | Reglas versionadas configurables; criterios institucionales pendientes. | 04; ejecución 08–10 |
...
| CAP-15 | Identidad RENAPER obligatoria con proveedor real, estados honestos, fallo técnico y reintento controlado. | pp. 2, 5, 10–11 | Fuera del alcance vigente por pedido del usuario (22/09/2026); no queda pendiente. | 09 |
| CAP-16 | Resultado inmediato/granular al guardar-validar, feedback de pendiente/error/corrección. | p. 10 | Controles de afiliación/requisitos y reintento conservados, sin identidad externa. | 08 |
...
| CAP-20 | Validaciones por lista y candidato: posiciones, paridad, alternancia, afiliación, requisitos y estado; revisión ADMIN (identidad externa retirada). | p. 5 | Controles actuales/históricos por candidato, composición y revisión contextual. | 11 |
...
- CAP-15: retirada del alcance; se conserva la referencia al manual como antecedente.
  CAP-16: resultados locales conservados. Ver [retiro y regresión](RETIRO_RENAPER.md).
...
La aceptación de producción requiere resolver las decisiones institucionales vigentes. La ausencia en padrón siempre conserva el registro.
